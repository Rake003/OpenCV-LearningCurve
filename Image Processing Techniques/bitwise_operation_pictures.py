# -*- coding: utf-8 -*-
"""
Created on Sat Jul 24 22:37:49 2021
...
image = cv2.imread('F:\Mastering_OpenCV_from_basics\OpenCV-LearningCurve\images/lenna_250.png')

# Load the binary image (but as a GBR color image - with 3 channels) (250x250):
binary_image = cv2.imread('F:\Mastering_OpenCV_from_basics\OpenCV-LearningCurve\images/opencv_binary_logo_250.png')
