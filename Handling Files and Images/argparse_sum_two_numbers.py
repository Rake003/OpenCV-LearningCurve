# -*- coding: utf-8 -*-
"""
Created on Sat Jul 17 16:07:02 2021
...
# We add 'second_number' argument using add_argument() including a help The type of this argument is 
int parser.add_argument("second_number", help="second number to be added", type=int) 
